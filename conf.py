...
BLOG_AUTHOR = "lovelyquark"  # (translatable)
BLOG_TITLE = "Adalace"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://adalace.org/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://adalace.org/"
BLOG_EMAIL = "gen@adalace.org"
BLOG_DESCRIPTION = "Arbitrary Analyses"  # (translatable)
...
NAVIGATION_LINKS = {
        DEFAULT_LANG: (
            ...
            ('http://adalace.org/stories/about-me/', 'About me', 'icon-user'),
            ('https://twitter.com/lovelyquark', 'My Twitter', 'icon-twitter'),
            ('https://github.com/gmsardane', 'My Github', 'icon-github'),
        )
}
...
PAGES = (
    ("stories/*.ipynb", "stories", "post.tmpl"),
